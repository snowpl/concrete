...
public final class MathView extends WebView {
  private String text;
  private static final String TAG = mathview.math.MathView.class.getSimpleName();
  ...
  private void init(Context context) {
    ...
    setWebViewClient(new WebViewClient() {
      ...
      public void onPageFinished(WebView view, String url) {
        pageLoaded = true;
        loadUrl("javascript:showFormula('" + mathview.math.MathView.this.text  + "')");
